...
if __name__ == '__main__':
    ...
    # Stage 4.5i
    s045i = s04
    SHP = specs['Shaft horse power [hp]'].values[0]
    SHP_SI = specs['Shaft horse power [kW]'].values[0]
    BSFC = specs['Specific Fuel Consumption (SFC) [kg/kW]'].values[0]
    eff_free_turbine = 1
    # eff_free_turbine = specs['eff_free_turbine'].values[0]
    m_air_test = 1
    w_PT, T045i, h045i, p045i , m_fuel, m_air, m_g = stage045i(BSFC, SHP_SI, m_air_test, excess_air, eff_free_turbine, h04, r, q, s045i)
    ...
    T5i, h5i, c5, Thrust = stage5ideal(r, q, s5i, p5i, h045, eff_nozzle, m_air, excess_air, eff_propeller, SHP)
    ...
    print('Specific Work of the Power Turbine = ', w_PT, 'kJ/kg')
