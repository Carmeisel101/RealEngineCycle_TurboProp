...
if __name__ == '__main__':
    ...
    m_air_test = 1
    w_PT, T045i, h045i, p045i, m_g, m_air_sol, m_fuel = stage045i(SHP, m_air_test, excess_air, eff_free_turbine, h04, r, q, s045i)
    ...
    T5i, h5i, c5, Spec_Thrust = stage5i(r, q, s5i, p5i, h045, eff_nozzle, m_air_test,
