...
if __name__ == '__main__':
    ...
    m_ref = m_air/1.02
    print('m_ref = ', m_ref)
    m_dot_1, m_dot_bar1 = part5(table_2_1, m_mbase, m_ref)
    m_dot_2, m_dot_bar2 = part5(table_2_1, m_mbase2, m_ref)
    m_dot_3, m_dot_bar3 = part5(table_2_1, m_mbase3, m_ref)
    m_dot_4, m_dot_bar4 = part5(table_2_1, m_mbase4, m_ref)
    m_dot_5, m_dot_bar5 = part5(table_2_1, m_mbase5, m_ref)

    # cmfr_1 = m_ref * np.sqrt(288.16) / (101325) * m_dot_bar1 *1e5
    # cmfr_2 = m_ref * np.sqrt(288.16) / (101325) * m_dot_bar2 *1e5
    # cmfr_3 = m_ref * np.sqrt(288.16) / (101325) * m_dot_bar3 *1e5
    # cmfr_4 = m_ref * np.sqrt(288.16) / (101325) * m_dot_bar4 *1e5
    # cmfr_5 = m_ref * np.sqrt(288.16) / (101325) * m_dot_bar5 *1e5
