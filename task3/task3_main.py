...
''' Task 3 is a multiply step process consisting of 22 parts'''
...
print('Metal Turning angle of the blade =', delta_beta1_til)
...
c_u_3, U_3, W_U_3, c_a3, alpha_3, Beta3, Beta_til_3, Beta_3_f_r, c_r3, h_r3, rho_r3, p_r3 = \
    step22(r, r_m, c_u_3_m, U_3_m, delta_ca, c_a1, incidence, m_air, h_02, U_2)
